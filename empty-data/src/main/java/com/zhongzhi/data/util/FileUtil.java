/*
 * ------------------------------------------------------------------------------
 * Copyright © 2020 Hangzhou DtDream Technology Co.,Lt d. All rights reserved.
 * ------------------------------------------------------------------------------
 * Product: HuaFeiBao
 * Module Name: agenter
...
public class FileUtil {
    ...
    public static synchronized boolean mergeFiles(String[] filePaths, String resultPath) {
        ...
        if (!resultFile.getParentFile().exists()) {
            ...
            if (!flag) {
                log.error("客户id:{}，号码匹配文件上传-创建合并结果文件路径：{}目录失败！", ThreadLocalContainer.getCustomerId(), resultFile.getParentFile());
