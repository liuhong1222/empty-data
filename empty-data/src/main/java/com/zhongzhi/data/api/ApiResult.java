...
public class ApiResult<T> implements Serializable {
    ...
    /**
     * 失败结果返回给HttpServletResponse
     * @param response HttpServletResponse
     * @param errorMsg 错误消息
     * @throws IOException IOExceptions
     */
    public static void failToResponse(HttpServletResponse response, ApiCode apiCode, String errorMsg) throws IOException {
        response.setContentType("application/json;charset=utf-8");
        response.getWriter().print(JSONObject.toJSONString(result(apiCode, errorMsg, null)));
    }
