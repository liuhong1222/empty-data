...
@MapperScan(basePackages="com.zhongzhi.data.mapper",sqlSessionFactoryRef = "sqlSessionFactory")
public class MybatisConfiguration implements TransactionManagementConfigurer {
    ...
    public SqlSessionFactory sqlSessionFactory() {
        try {
            ...
            sessionFactoryBean.getObject().getConfiguration().setMapUnderscoreToCamelCase(mapUnderscoreToCamelCase);
